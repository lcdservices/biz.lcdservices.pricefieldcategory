 ...
 */
class CRM_PriceFieldCategory_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_PriceFieldCategory_Upgrader(
        'biz.lcdservices.pricefieldcategory',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_PriceFieldCategory_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
